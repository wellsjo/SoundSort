	...
	<div class="row">
		...
		<div class="span8 offset1" style="height:45px;position:relative; width:783px;">
			...
			<h5 style="padding-left: 31px; color:gray; margin-top:7px; font-size:20px;">
				...
				<a href="/<?php echo $active; ?>/<?php echo $page - 1; ?>" class="btn _page" style="margin-left: 27px;" <?php echo $disabled;?>><i class="icon-arrow-left icon-black"></i></a>
				<a href="/<?php echo $active; ?>/<?php echo $page + 1; ?>" class="btn _page"><i class="icon-arrow-right icon-black"></i></a>
		...
		<div class="span8 offset1" style="position:relative;">
			<h5 style="padding-left: 31px;color:gray; margin-top:7px; font-size:20px;">
				...
				<a href="/<?php echo $active; ?>/<?php echo $page - 1; ?>" class="btn _page" <?php echo $disabled; ?> style="margin-left: 27px;"><i class="icon-arrow-left icon-black"></i></a>
				<a href="/<?php echo $active; ?>/<?php echo $page + 1; ?>" class="btn _page" ><i class="icon-arrow-right icon-black"></i></a></h5>
		</div>
	</div>
</div>